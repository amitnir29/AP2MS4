...
namespace FlightControlWebTests.Model
{
    [TestClass()]
    public class FlightCalculatorUnitTests
    {
        ...
        public void AskFlightBeforeLaunch()
        {
            ...
            FlightPlan flightPlan = new FlightPlan("test1", 256, "TestCompany", launch, new FlightStatus[2] { middle, end });
        ...
        public void AskFlightLaunchTime()
        {
            ...
            Assert.AreEqual(launch.Longitude, res.Status.Longitude);
            Assert.AreEqual(launch.Latitude, res.Status.Latitude);
        }
        ...
        public void AskFlightMiddleTime()
        {
            ...
            Assert.AreEqual(middle.Longitude, res.Status.Longitude);
            Assert.AreEqual(middle.Latitude, res.Status.Latitude);
        }
        ...
        public void AskFlightEndTime()
        {
            ...
            Assert.AreEqual(end.Longitude, res.Status.Longitude);
            Assert.AreEqual(end.Latitude, res.Status.Latitude);
        }
        ...
        public void AskFlightMereTime()
        {
            ...
            Assert.AreEqual(150, res.Status.Longitude);
            Assert.AreEqual(150, res.Status.Latitude);
        }
    }
}
